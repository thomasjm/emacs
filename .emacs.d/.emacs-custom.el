(custom-set-variables
 ...
 '(exec-path
   (quote
    ("/Users/tomm/path" "/usr/bin" "/bin" "/usr/sbin" "/sbin" "/Applications/Emacs.app/Contents/MacOS/libexec" "/Applications/Emacs.app/Contents/MacOS/bin" "/usr/local/bin" "/usr/local/Cellar/ghc/7.6.3/bin/" "/usr/local/Cellar/imagemagick/6.8.9-1/bin" "/Users/tomm/Library/Haskell/bin/")))
 '(fci-rule-color "#073642")
 '(haskell-mode-hook (quote (turn-on-haskell-indent (lambda nil (ghc-init)))) t)
